...
const Carousel: React.FC = () => {
  ...
  return (
    <section className="mb-8 font-nunito text-center mx-auto py-4 md:py-10 md:px-20 md:bg-white md:rounded-md lg:px-24 ">
      <h2 className="mb-3 font-ubuntu text-2xl font-bold text-center md:text-3xl">
        Gallery.
      </h2>
      ...
      <div className="carousel-container mx-auto w-full">
        ...
        >
          {[Poster1, Poster2, Poster3, Poster4, Poster5, Poster6].map(
            (slider: StaticImageData, index) => (
              <SwiperSlide
                key={index}
                className="flex justify-center items-center"
              >
                <div className="w-full md:w-[60%] md:mx-auto lg:w-[50%]">
                  <Image
                    src={slider}
