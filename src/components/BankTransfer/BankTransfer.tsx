  ...
  return (
    <>
      ...
      <section className="mb-8 rounded-md font-nunito bg-pricingbackground3">
        <div className="px-3 py-4">
          <p className="mb-8 font-semibold">Transaction range - Above 50,000</p>
          <div className="mb-8">
            <div className="flex mb-4 items-center">
              <Image
                src={Check}
          ...
          <div>
            ...
            <p className="mb-2">Funds to be received = 99,945 (100,000 – 55)</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-8 rounded-md font-nunito bg-pricingbackground3">
        <div className="px-3 py-4">
          ...
          <div>
            ...
            <p className="mb-2">Funds to be received = 99,940 (100,000 – 60)</p>
          </div>
        </div>
      </section>
    </>
